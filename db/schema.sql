...
CREATE TABLE "historical_air_quality"(
    ...
    "date" DATE NOT NULL,
    "location_id" INTEGER NOT NULL,
    "mean_air_quality_index" SMALLINT NOT NULL,
    "mean_carbon_monoxide" FLOAT NOT NULL,
    "mean_nitrogen_dioxide" FLOAT NOT NULL,
    "mean_nitrogen_monoxide" FLOAT NOT NULL,
    "mean_ammonia" FLOAT NOT NULL,
    "mean_ozone" FLOAT NOT NULL,
    "mean_sulphur_dioxide" FLOAT NOT NULL,
    "mean_pm2_5" FLOAT NOT NULL,
    "mean_pm10" FLOAT NOT NULL,
