...
if __name__ == "__main__":
    ...
    st.markdown(
        ...
        - Alerts
          - Be notified via email whenever there are any flood alerts, if air quality index has reached 4/5 or greater, or if any weather values have broken a record
        - Daily Summary
